...
var _contracts = require('../lib/contracts');
...
var App = function (_Component) {
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.updateBlockchainState = function () {
      ...
      _this.forceUpdate();
      _this.updateTimeout = setTimeout(_this.updateBlockchainState, 12000);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement(_SimpleTable2.default, { contractStates: _contracts.Wallet.getContractState() })
        )
      );
    }
  }]);
